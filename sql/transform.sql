CREATE OR REPLACE FUNCTION transform(data json)
  RETURNS json AS
$BODY$
	var array = [];

	for(var i = 0; i<=3; i++){array[i] = 0;}
	...
	for(var i = 87; i<=282; i++){array[i] = 0;}
